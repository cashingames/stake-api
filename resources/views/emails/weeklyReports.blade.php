    ...
    <div style="padding: 20px;background-color: #e6ffff;overflow-x:auto;">
        <table style="width:100%; border-collapse: collapse; font-size: 0.9em;font-family: sans-serif;min-width: 400px;box-shadow: 0 0 20px rgba(0, 0, 0, 0.15);">
            <tr style=" color: gray;text-align: left;">
                <th style="padding-top: 12px; padding-bottom: 12px;text-align: left;  border: 1px solid #dddddd;text-align: left;padding: 8px;">Bogus Net Platform Gain (with bonuses)</th>
            ...
            <tr style=" color: gray;text-align: left; background-color: #dddddd;">
                <th style="padding-top: 12px; padding-bottom: 12px;text-align: left;  border: 1px solid #dddddd;text-align: left;padding: 8px;">True Net Platform Gain (without bonuses)</th>
            ...
            <tr style=" color: gray;text-align: left; background-color: #dddddd;">
                ...
                <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">₦{{$data['timeFreezeboostBoughtAmount']}}</td>
            </tr>
            <tr style=" color: gray;text-align: left; ">
                ...
                <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">₦{{$data['skipBoostBoughtAmount']}}</td>
            </tr>
            <tr style=" color: gray;text-align: left; background-color: #dddddd;">
                ...
                <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">{{$data['timeFreezeboostBoughtCount']}}</td>
            </tr>
            <tr style=" color: gray;text-align: left;">
                ...
                <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">{{$data['skipBoostBoughtCount']}}</td>
            </tr>
            <tr style=" color: gray;text-align: left; background-color: #dddddd;">
                ...
                <td style="border: 1px solid #dddddd;text-align: left;padding: 8px;">{{$data['averageStakesPerStaker']}}</td>
            </tr>
            <tr style=" color: gray;text-align: left; ">
