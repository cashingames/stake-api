...
Route::get('v2/game/challenge/accept/{challengeId}',[GameController::class, 'acceptChallenge']);
Route::get('v2/game/challenge/decline/{challengeId}',[GameController::class, 'declineChallenge']);